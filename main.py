...
mentor_reviewer_1.rate_hw_student(student_1, 'Django', 10)
...
mentor_reviewer_1.rate_hw_student(student_2, 'Django', 9)


mentor_reviewer_2.rate_hw_student(student_1, 'Python', 10)
mentor_reviewer_2.rate_hw_student(student_1, 'Python', 10)
mentor_reviewer_2.rate_hw_student(student_1, 'Django', 8)
mentor_reviewer_2.rate_hw_student(student_1, 'Django', 10)


mentor_reviewer_2.rate_hw_student(student_2, 'Python', 8)
mentor_reviewer_2.rate_hw_student(student_2, 'Python', 8)
mentor_reviewer_2.rate_hw_student(student_2, 'Django', 8)
mentor_reviewer_2.rate_hw_student(student_2, 'Django', 9)

student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 10)
student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 7)
student_1.rate_hw_lecturer(mentor_lecturer_1, 'Django', 8)
...
student_2.rate_hw_lecturer(mentor_lecturer_2, 'Django', 9)
student_2.rate_hw_lecturer(mentor_lecturer_2, 'Django', 8)
